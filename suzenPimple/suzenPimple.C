...
Description
	Solver for charge density and DBD induced Sbody force (time-dependant) by the Suzen model coupled 
    with a transient solver for incompressible, turbulent flow of Newtonian fluids.

    Turbulence modelling is generic, i.e. laminar, RAS or LES may be selected.
	
	NOTE: a suzenPotential solver case must be exectuded first, since 
    its computed fields are required as initial conditions by suzenPimple.
