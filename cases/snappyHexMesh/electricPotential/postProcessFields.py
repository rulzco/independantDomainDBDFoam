...
From electric potential domain
"""
...
# plt.savefig('C:/Users/ruloz/Desktop/'+case+'rho_c.pdf')
...
plt.xlabel('x [m]');plt.ylabel('y [m]')
# plt.savefig('C:/Users/ruloz/Desktop/'+case+'ElPot.pdf')
...
plt.xlabel('x [m]');plt.ylabel('y [m]')
# plt.savefig('C:/Users/ruloz/Desktop/'+case+'Efield.pdf')
...
# plt.xlabel('x [m]');plt.ylabel('y [m]')
# plt.savefig('C:/Users/ruloz/Desktop/'+case+'force.pdf')
